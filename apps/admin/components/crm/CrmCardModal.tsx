...
export default function CrmCardModal({
  ...
  const handleCreateQuote = useCallback(async (e?: React.MouseEvent) => {
    ...
    try {
      ...
      if (response.success && response.quote) {
        ...
        // Close form first, then set data and open preview
      ...
      {createdQuote && showQuotePreview && (
        <QuotePreviewModal
          ...
          data={{
            ...
            taxRate: createdQuote.tax_rate,
            taxAmount: createdQuote.tax_amount,
