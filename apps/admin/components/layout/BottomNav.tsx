...
const navItems: NavItem[] = [
  ...
  { label: 'Rapport', href: '/dashboard/tech/report', icon: PenLine, roles: ['technicien'] },
  { label: 'Rapports', href: '/dashboard/reports', icon: ClipboardList, roles: ['admin', 'super_admin'] },
